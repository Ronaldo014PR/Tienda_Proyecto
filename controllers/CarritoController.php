...
class CarritoController{
    ...
    public static function pagar(){
        ...
        if($_SERVER['REQUEST_METHOD']==='POST'){
            ...
            $stripe = new \Stripe\StripeClient('sk_test_51NQ1WzLWPl0caJDp0Vhzb9xqEvwLB6ilxjErABZcxC5wKcYL6sV3wN4gm9xuxWc27zRafko5vZTheYpOkAeiJ5fA00vMdvjBT2');
            
            $session =$stripe->checkout->sessions->create([
                'payment_method_types' => ['card'],
                'line_items' => $lineItems,
                'mode' => 'payment',
                'success_url' => 'http://localhost:3000/pagado?id='.$idUsuario.'&token='.$token,
