...
// const suma= document.querySelector('.btn-info');
// const resta= document.querySelector('.btn-danger');
// const compra={
//     idUsuario:'',
//     articulosCarrito: []
// }
...
function agregarCurso(e) {
    ...
    // Delegation para irDetalles
    // if(e.target.classList.contains('irDetalles')) {
    //     const curso = e.target.parentElement;
    //     // console.log(curso.querySelector('button').getAttribute('data-id'));
        
    //     // Enviamos el curso seleccionado para tomar sus datos
    //     return irDetalles(curso);
...
async function actualizarInventario(){
    ...
    // console.log(parametro1); // Imprimirá "valor1"

    // const parametro2 = params.get('parametro2');
    // console.log(parametro2); // Imprimirá "valor2"
    ...
    try {
        ...
        // const url = 'http://localhost:3000/pagado'
        const respuesta=await fetch(url,{
        method:'POST',
        body:datos //IMPORTANTE PARA PASAR LOS DATOS AL FETCH
        });
