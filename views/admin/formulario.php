...
<fieldset>
    ...
    <input type="number" id="Precio" step="0.01" name="productos[Precio]" placeholder="Precio del producto" value="<?php echo $producto->Precio ? s(trim( $producto->Precio ) ) :''; ?>">
...
<fieldset>
    ...
    <input type="number" id="Popularidad" step="0.01" name="productos[Popularidad]" placeholder="Popularidad del producto" value="<?php echo s(trim( $producto->Popularidad) ); ?>">
